...
@Component({
  ...
  template: `
    <nav class="fixed top-3.5 left-1/2 -translate-x-1/2 z-50 w-[95%] max-w-6xl">
      <div class="bg-kore-black/30 backdrop-blur-3xl border border-kore-white/10 rounded-xl px-4 md:px-6 py-3 flex items-center justify-between shadow-[0_8px_32px_rgba(0,0,0,0.15),inset_0_1px_1px_rgba(255,255,255,0.03)] transition-all duration-500">
        ...
        <div class="flex items-center gap-3">
          ...
          <button (click)="navigateAndScroll('#cta')" class="h-[36px] px-4 bg-kore-white text-kore-black text-[10px] font-bold rounded-lg hover:scale-105 transition-all uppercase tracking-widest shadow-[0_0_20px_rgba(255,255,255,0.15)] active:scale-95 border-none">
            Acesso Antecipado
          </button>
        </div>
      </div>
