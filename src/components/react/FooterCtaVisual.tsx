  ...
  return (
    <div ref={ref} className="w-full flex flex-col items-center">
      ...
      <motion.div
        ...
        className="inline-flex items-center gap-3 px-4 py-2 mb-10 bg-danger/10 border border-danger/25 rounded-full"
      >
...
export function FooterStats() {
  ...
  return (
    <div
      ref={ref}
      className="grid grid-cols-3 divide-x divide-border-subtle border-y border-border-subtle w-full max-w-2xl mx-auto"
    >
      {STATS.map((s, i) => (
        <motion.div
          key={s.label}
